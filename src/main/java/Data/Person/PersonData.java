...
public class PersonData {
    ...
    public boolean addPerson(Person person) {
        String sql = "INSERT INTO [argyranthemum].[person].[tbPerson] (name, lastname, type_idcard, idcard, birth_date, nationality, gender, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
        try {
    ...
    public boolean updatePerson(Person person) {
        String sql = "UPDATE [argyranthemum].[person].[tbPerson] SET name = ?, lastname = ?, type_idcard = ?, idcard = ?, birth_date = ?, nationality = ?, gender = ?, status = ? WHERE id = ?";
        try {
    ...
    public boolean logicalDeletePerson(int id) {
        String sql = "UPDATE [argyranthemum].[person].[tbPerson] SET status = false WHERE id = ?";
        try {
    ...
    public boolean deletePerson(int id) {
        String sql = "DELETE FROM [argyranthemum].[person].[tbPerson] WHERE id = ?";
        try {
            jdbcTemplate.update(sql, id);
            return true;
        } catch (Exception e) {
    ...
    public Person getPersonById(int id) {
        String sql = "SELECT * FROM [argyranthemum].[person].[tbPerson] WHERE id = ?";
        try {
    ...
    public int getIdPersonByIdCard(String idCard, String idCardType) {
        String sql = "SELECT id FROM [argyranthemum].[person].[tbPerson] WHERE idcard = ? AND type_idcard = ?";
          int id = 0;
        try {
    ...
    public List<Person> getAllPersons() {
        String sql = "SELECT * FROM [argyranthemum].[person].[tbPerson]";
        try {
